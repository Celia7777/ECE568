...
void createXML(std::string& ref,std::string id, std::string balance, std::string sym, double symNum){
    //declaration
...
//back up for createXML
//see the modified version above
...
//     root->InsertEndChild(account2);
//     root->InsertEndChild(symbol);
//     // root->InsertEndChild(symbol_account);
//     root->InsertEndChild(symbol2);
//     //convert to string
//     XMLPrinter printer;
//     doc.Print(&printer);

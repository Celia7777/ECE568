...
int main(int argc, char *argv[]){
    ...
    std::cout <<"send test: "<< ref3 << std::endl;
    std::cout <<"send test: "<< ref4 << std::endl;
    ...
    while(1){
        ...
        //<transactions>
        // std::cout<<"counter: "<< counter<< " send test from client: "<<ref4.c_str() << "len: "<<ref2.length() +1 <<std::endl;
        send(client_fd, ref3.c_str(), ref3.length() + 1, 0);
